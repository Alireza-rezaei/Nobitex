		...
		<>
			...
			>
				...
				>
					...
					<div
						className={`prices__box absolute opacity-0 lg:opacity-100 top-10 bg-white w-full origin-top lg:w-[10rem]  lg:right-3 lg:top-9 text-sm shadow-2xl border z-40 border-slate-100 rounded-lg lg:rounded-md h-auto ${

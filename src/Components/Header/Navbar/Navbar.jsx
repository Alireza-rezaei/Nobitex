...
export default function Navbar() {
	...
	return (
		<nav
			className='flex flex-row items-center justify-between p-4 lg:p-3 flex-wrap relative '
			style={{ WebkitTapHighlightColor: 'transparent' }}
		>
			<div
				className={` ${
					showSubMenu ? 'opacity-70' : 'opacity-0 hidden'
				} fixed inset-0 bg-dark  z-10 duration-500 ease-in-out transition-all lg:scale-0 scale-100`}
			></div>
